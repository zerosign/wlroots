...
#ifndef WLR_TYPES_EXT_WLR_VIRTUAL_KEYBOARD_V1_H
#define WLR_TYPES_EXT_WLR_VIRTUAL_KEYBOARD_V1_H
...
struct wlr_ext_virtual_keyboard_manager_v1 {
	...
	struct wl_list ext_virtual_keyboards; // wlr_ext_virtual_keyboard_v1.link

	struct wl_listener display_destroy;

	struct {
		struct wl_signal new_ext_virtual_keyboard; // struct wlr_ext_virtual_keyboard_v1
